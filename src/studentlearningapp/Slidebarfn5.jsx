...
import Javacoding from "./Javacoding";
import Javascriptcoding from "./Javascriptcoding";
...
function ResponsiveDrawer4(props) {
 
  const { window } = props;
  const [mobileOpen, setMobileOpen] = React.useState(false);
  
  
  const [menudata, setMenudata] = React.useState("Python Coding");
        ...
        <List>
          ...
          >
            ...
            <ListItemButton sx={{ textShadow: "0px 0px 1px" }}>
              ...
              <ListItemText primary="Python Coding" />
            </ListItemButton>
          </ListItem>
          <ListItem
            disablePadding
            onClick={() => {
             setMenudata("Java Coding")
              handleDrawerToggle();
            }}
          >
            <ListItemButton sx={{ textShadow: "0px 0px 1px" }}>
              
              <ListItemText primary="Java Coding" />
            </ListItemButton>
          </ListItem>
          <ListItem
            disablePadding
            onClick={() => {
              setMenudata("Javascript Coding")
              handleDrawerToggle();
            }}
          >
            <ListItemButton sx={{ textShadow: "0px 0px 1px" }}>
              
              <ListItemText primary="Javascript Coding" />
            </ListItemButton>
          </ListItem>
          <ListItem
            disablePadding
            onClick={() => {
              setMenudata("React Coding")
              handleDrawerToggle();
            }}
          >
            <ListItemButton sx={{ textShadow: "0px 0px 1px" }}>
              
              <ListItemText primary="React Coding" />
            </ListItemButton>
          </ListItem>
          {/* <ListItem
            disablePadding
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        {/* <HorizontalLinearStepper/> */}
         ...
         {menudata === "Python Coding" && <Pythoncoding />}
         {menudata === "Java Coding" && <Javacoding />}
        {menudata === "Javascript Coding" && <Javascriptcoding />}
        {menudata === "React Coding" && <Reactcoding />}
...
export default ResponsiveDrawer4;
